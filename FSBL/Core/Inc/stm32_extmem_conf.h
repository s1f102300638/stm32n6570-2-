...
// /* /* #include "stm32_extmem.h" */ */ /* File not found */ // Commented out - file not found
/* #include "stm32_extmem_type.h" -- File not found */


/* External memory type definitions - temporary */
#ifndef EXTMEM_TYPE_DEFINED
#define EXTMEM_TYPE_DEFINED
typedef struct {
    uint32_t dummy;
...
typedef struct { uint32_t dummy; } EXTMEM_DefinitionTypeDef; /* Dummy type */
